...
Ghost::Ghost(Pacman const& pacman, Point start, Point scatter)
: pacman{pacman}, start{start}, scatter{scatter}
{
}
...
Blinky::Blinky(Pacman const& pacman, Point start, Point scatter)
: Ghost(pacman, start, scatter)
{
}
...
Pinky::Pinky(Pacman const& pacman, Point start, Point scatter)
: Ghost(pacman, start, scatter)
{
}
...
Clyde::Clyde(Pacman const& pacman, Point start, Point scatter, int n)
: Ghost(pacman, start, scatter), n{n}
{
}
